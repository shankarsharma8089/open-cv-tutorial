...
#Loads an image
#Applies 4 different kinds of filters:
...
#Parameters:
s#rc - It represents the source(input) image.
#dst - It represents the destination (output) image.
#kernel - It represents the Kernel.

#using both in a image
import cv2  
import numpy as np  
img = cv2.imread(r'image', 1)  
...
# if the image is written to a file if the pressed key was the "s"-key. For this the cv::imwrite function is called that has the file path and the cv::Mat object as an argument.
